...
function sakura_scripts()
{
    if (iro_opt('local_global_library')) {
        ...
        wp_enqueue_script('js_lib', 'https://cdn.jsdelivr.net/combine/gh/Fuukei/Sakurairo-zh_tw@' . SAKURA_VERSION . '/cdn/js/lib.min.js,gh/Fuukei/Sakurairo-zh_tw@' . SAKURA_VERSION . '/cdn/js/src/20.SmoothScroll.js', array(), SAKURA_VERSION, true);
        wp_enqueue_script('Aplayer', 'https://cdn.jsdelivr.net/combine/gh/Fuukei/Sakurairo-zh_tw@' . SAKURA_VERSION .  '/cdn/js/src/07.APlayer.min.js', array(), SAKURA_VERSION, true);
        if (iro_opt('aplayer_server') != 'off')wp_enqueue_script('Aplayer', 'https://cdn.jsdelivr.net/combine/gh/Fuukei/Sakurairo-zh_tw@' . SAKURA_VERSION .  '/cdn/js/src/07.APlayer.min.js', array(), SAKURA_VERSION, true);
    } else {
        wp_enqueue_script('js_lib', 'https://cdn.jsdelivr.net/gh/Fuukei/Sakurairo-zh_tw@' . SAKURA_VERSION . '/cdn/js/lib.min.js', array(), SAKURA_VERSION, true);
        wp_enqueue_script('Aplayer', 'https://cdn.jsdelivr.net/combine/gh/Fuukei/Sakurairo-zh_tw@' . SAKURA_VERSION .  '/cdn/js/src/07.APlayer.min.js', array(), SAKURA_VERSION, true);
        if (iro_opt('aplayer_server') != 'off')wp_enqueue_script('Aplayer', 'https://cdn.jsdelivr.net/combine/gh/Fuukei/Sakurairo-zh_tw@' . SAKURA_VERSION .  '/cdn/js/src/07.APlayer.min.js', array(), SAKURA_VERSION, true);
    }
    if (iro_opt('local_application_library')) {
        ...
        wp_enqueue_style('saukra_css', 'https://cdn.jsdelivr.net/gh/Fuukei/Sakurairo-zh_tw@' . SAKURA_VERSION . '/style.min.css', array(), SAKURA_VERSION);
        wp_enqueue_script('app', 'https://cdn.jsdelivr.net/gh/Fuukei/Sakurairo-zh_tw@' . SAKURA_VERSION . '/js/sakura-app.min.js', array(), SAKURA_VERSION, true);
    }
